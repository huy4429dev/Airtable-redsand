...
const detailtProjectReducers = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case types.SHOW_MODAL_ADD_ATTACHMENT:
            return { ...state, showModalAddAttachment:true
             }
             case types.HIDE_MODAL_ADD_ATTACHMENT:
             return {...state, showModalAddAttachment:false}
